    ...
    <AppShell>
      <div className="mb-4">
        ...
        <p className="text-muted mt-0.5 text-xs">
          Net worth: <span className="font-semibold text-white">{money(String(totalValue))}</span>
        </p>
      </div>
      ...
      <div className="glass-card rounded-2xl p-5">
        {assets.length === 0 ? (
          ...
          <div className="space-y-2">
            {assets.map((a) => (
              <div key={a.id} className="input flex items-center justify-between rounded-xl px-3 py-2.5 text-sm">
